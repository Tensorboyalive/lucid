    ...
    <main>
      ...
      <Section tone="cream" className="pb-8 pt-6 md:pb-12 md:pt-10">
        ...
        <p className="mt-8 max-w-[58ch] text-[clamp(1.02rem, calc(0.92rem + 0.35vw), 1.22rem)] leading-[1.5] text-ink/80">
          lucid:v2 is in closed iteration. Drop your email and we&rsquo;ll let
          you in when the engine opens up. No drip, no newsletter, no noise
          &mdash; one message when it&rsquo;s your turn.
        </p>
      </Section>
        ...
        {phase !== "done" ? (
          ...
          >
            ...
            <p className="max-w-[58ch] text-[1.05rem] leading-[1.55] text-ink/75">
              In the meantime, the product is live in demo mode if you want
              to poke around. Score a reel, research a creator, rewrite a
              draft &mdash; no keys needed.
            </p>
